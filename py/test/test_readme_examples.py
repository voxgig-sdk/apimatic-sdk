# Apimatic SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ApimaticSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ApimaticSDK(...) and ApimaticSDK.test(...) become
#      ApimaticSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "apimatic_sdk"
_SDK_CLASS = "ApimaticSDK"
