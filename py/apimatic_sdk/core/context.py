...
from apimatic_sdk.core.control import ApimaticControl
...
from apimatic_sdk.core.helpers import get_ctx_prop, to_map
...
class ApimaticContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, ApimaticResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ApimaticResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return ApimaticError(code, msg, self)
