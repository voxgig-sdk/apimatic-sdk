...
from apimatic_sdk.apimatic_types import (
    Transform,
    TransformCreateData,
)
...
class TransformEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return TransformEntity(self._client, opts)
    ...
    def create(self, reqdata: TransformCreateData, ctrl=None) -> Transform:
        utility = self._utility
