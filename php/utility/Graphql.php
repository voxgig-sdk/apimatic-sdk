...
class ApimaticGraphql
{
    ...
    // equivalent.
    public static function body(ApimaticContext $ctx): mixed
    {
    ...
    public static function errors(ApimaticContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
