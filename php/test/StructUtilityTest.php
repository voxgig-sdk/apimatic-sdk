...
// Apimatic SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = ApimaticOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(ApimaticOmni::structfix($now, Struct::undef()))
                        !== json_encode(ApimaticOmni::structfix($val, Struct::undef()))) {
