...
class ApimaticTestRunner
{
    ...
    {
        $live = self::getenv('APIMATIC_TEST_LIVE');
        $override = self::getenv('APIMATIC_TEST_OVERRIDE');
        ...
        $explain = self::getenv('APIMATIC_TEST_EXPLAIN');
...
class_alias('ApimaticTestRunner', 'Runner');
class_alias('ApimaticHelpers', 'Helpers');
