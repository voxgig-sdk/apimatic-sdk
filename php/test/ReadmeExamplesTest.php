...
// Apimatic SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ApimaticSDK::test)
...
{
    private const SDK_CLASS = 'ApimaticSDK';
    ...
    private const SDK_BASE = 'apimatic_sdk';
