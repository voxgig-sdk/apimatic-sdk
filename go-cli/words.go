...
func registerSDKWords(r *eng.Registry, client *sdk.ApimaticSDK) {
...
func runOp(client *sdk.ApimaticSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
