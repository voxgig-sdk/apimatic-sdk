// Command Apimatic-cli is a CLI + REPL for the Apimatic SDK,
...
const prompt = "apimatic"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "transform"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      APIMATIC_APIKEY (api key), APIMATIC_BASE (base url override)")
...
func run(args []string, in io.Reader, out, errOut io.Writer) int {
	...
	// Configure from the environment: APIMATIC_APIKEY carries the API key and
	// APIMATIC_BASE optionally overrides the API base URL (e.g. production).
	// Both injectable by a secrets vault. Unset -> nil config defaults.
	var opts map[string]any
	if apikey := os.Getenv("APIMATIC_APIKEY"); apikey != "" {
		opts = map[string]any{"apikey": apikey}
	}
	if base := os.Getenv("APIMATIC_BASE"); base != "" {
		if opts == nil {
			opts = map[string]any{}
		}
		opts["base"] = base
	}
	client := sdk.NewApimaticSDK(opts)
