...
type Args struct {
	Entity string         `json:"entity" jsonschema:"transform"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.ApimaticSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "apimatic_list",
		Description: "List records from Apimatic. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "apimatic_load",
		Description: "Load a single record from Apimatic. " +
...
func runOp(client *sdk.ApimaticSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ApimaticSDK, name string) (sdk.ApimaticEntity, error) {
	switch strings.ToLower(name) {
	case "transform":
		return client.Transform(nil), nil
