...
function envOverride(m) {
    if ('TRUE' === process.env.APIMATIC_TEST_LIVE ||
        'TRUE' === process.env.APIMATIC_TEST_OVERRIDE) {
    ...
    m.APIMATIC_TEST_EXPLAIN = process.env.APIMATIC_TEST_EXPLAIN || m.APIMATIC_TEST_EXPLAIN;
    return m;
}
