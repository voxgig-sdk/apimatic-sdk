...
// Apimatic SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class ApimaticTestFeature extends ApimaticBaseFeature
{
    ...
    public function init(ApimaticContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (ApimaticContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (ApimaticContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(ApimaticContext $ctx, $op, $args): array
    {
