...
// Apimatic SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class ApimaticMakeRequest
{
    public static function call(ApimaticContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new ApimaticResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new ApimaticResponse($fetched);
        } else {
