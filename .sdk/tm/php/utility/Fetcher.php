...
// Apimatic SDK utility: fetcher

class ApimaticFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ApimaticSDK/1.0)';
    ...
    public static function call(ApimaticContext $ctx, string $fullurl, array $fetchdef): array
    {
