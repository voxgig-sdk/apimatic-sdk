...
class ApimaticTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ApimaticTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = ApimaticTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = ApimaticTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
