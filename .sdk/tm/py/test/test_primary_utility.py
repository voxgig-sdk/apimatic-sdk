...
from projectname_sdk import ApimaticSDK
from projectname_sdk.core.spec import ApimaticSpec
from projectname_sdk.core.result import ApimaticResult
from projectname_sdk.core.response import ApimaticResponse
from projectname_sdk.core.operation import ApimaticOperation
from projectname_sdk.core.error import ApimaticError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import ApimaticBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = ApimaticSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = ApimaticSDK.test(None, None)
        ...
        class TestInitFeature(ApimaticBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(ApimaticBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = ApimaticSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = ApimaticSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = ApimaticSDK.test(None, setup_opts)
