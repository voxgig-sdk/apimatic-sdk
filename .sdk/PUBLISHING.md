...
|---|---|---|
| `js/` | @voxgig-sdk/apimatic-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/apimatic | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/apimatic-js \
      --repository voxgig-sdk/apimatic-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/apimatic-js` shows it, and
`npm trust revoke @voxgig-sdk/apimatic-js --id=<id>` removes it.
