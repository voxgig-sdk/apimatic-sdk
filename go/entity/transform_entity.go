...
func NewTransformEntity(client *core.ApimaticSDK, entopts map[string]any) *TransformEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TransformEntity) GetName() string { return e.name }
...
func (e *TransformEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TransformEntity) Deleted() bool {
	return e.deleted
}


func (e *TransformEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTransformEntity(e.client, opts)
}

func (e *TransformEntity) Data(args ...any) any {
...
func (e *TransformEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Transform; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TransformEntity) DataTyped(data ...Transform) Transform {
	if len(data) > 0 {
		return typedFrom[Transform](e.Data(asMap(data[0])))
	}
	return typedFrom[Transform](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Transform (all fields
// optional at the wire level).
func (e *TransformEntity) MatchTyped(match ...Transform) Transform {
	if len(match) > 0 {
		return typedFrom[Transform](e.Match(asMap(match[0])))
	}
	return typedFrom[Transform](e.Match())
}
...
func (e *TransformEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TransformEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *TransformEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *TransformEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TransformCreateData and returns an Transform. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *TransformEntity) CreateTyped(reqdata TransformCreateData, ctrl map[string]any) (Transform, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Transform{}, err
	}
	return typedFrom[Transform](res), nil
}



func (e *TransformEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TransformEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TransformEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
